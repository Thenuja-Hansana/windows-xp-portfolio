...
const LINKS = [
    {
        icon: '🐙',
        label: 'GitHub',
        sub: 'github.com/Thenuja-Hansana',
        href: 'https://github.com/Thenuja-Hansana',
        color: '#24292e',
    },
    {
        icon: '💼',
        label: 'LinkedIn',
        sub: 'linkedin.com/in/thenuja-rajapaksha/',
        href: 'https://www.linkedin.com/in/thenuja-rajapaksha/',
        color: '#0077b5',
    },
    {
        icon: '🐦',
        label: 'Twitter / X',
        sub: 'x.com/ThenujaCodes',
        href: 'https://x.com/ThenujaCodes',
        color: '#1da1f2',
    },
    {
        icon: '▶️',
        label: 'YouTube',
        sub: 'youtube.com/@ThenujaCodes',
        href: 'https://www.youtube.com/@ThenujaCodes',
        color: '#ff0000',
    },
    {
        icon: '📸',
        label: 'Instagram',
        sub: 'instagram.com/thenuja_rj/',
        href: 'https://www.instagram.com/thenuja_rj/',
        color: '#e1306c',
    },
]
